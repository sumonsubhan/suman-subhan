...
import { addArticleCategory } from "@/actions/addArticleCategory";
...
export default function AddCategory() {
  ...
  async function onSubmit(data) {
    ...
    const result = await addArticleCategory(formData);
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <h1 className="text-3xl font-bold mb-8">Add New Article Category</h1>
