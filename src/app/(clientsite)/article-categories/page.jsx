...
export const metadata = {
  ...
  description:
    "সুমন সুবহানের প্রবন্ধ, কলাম, বিশ্লেষণ ও মতামতের সংগ্রহ। রাজনীতি, সাহিত্য, সমাজ, ইতিহাস, নিরাপত্তা এবং সমসাময়িক বিভিন্ন বিষয়ে লেখা পড়ুন। Explore articles, essays, columns, and analyses by Suman Subhan.",
  ...
  openGraph: {
    title: "লেখালোক | সুমন সুবহান",
    description: "সুমন সুবহানের প্রবন্ধ, কলাম, বিশ্লেষণ ও মতামতের সংগ্রহ।",
    url: "/articles",
    images: [
      {
        url: "/og-image.jpg",
